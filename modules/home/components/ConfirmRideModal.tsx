...
// Import ScanQrCodeComponent type for reference
let ScanQrCodeComponent: any;
...
const ConfirmRideModal: React.FC<Props> = ({scooterCode, scooterData, onCancel}) => {
  ...
  return (
    <View style={styles.container}>
      <H2 customStyles={{textAlign: 'center', marginBottom: 8}}>Confirm Ride</H2>
