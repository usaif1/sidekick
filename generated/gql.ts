...
type Documents = {
    ...
    "query fetchActiveRide($userId: uuid!) {\n  ride_details(\n    where: {user_id: {_eq: $userId}, end_time: {_is_null: true}, ride_steps: {steps: {_in: [\"RIDE_STARTED\", \"RIDE_PAUSED\", \"RIDE_RESUMED\"]}}, _not: {ride_steps: {steps: {_eq: \"RIDE_ENDED\"}}}}\n    order_by: {created_at: desc}\n    limit: 1\n  ) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n    scooter {\n      id\n      registration_number\n      status\n      device_name\n      imei\n    }\n    hubByStartHubId {\n      id\n      name\n      latitude\n      longitude\n    }\n  }\n}": typeof types.FetchActiveRideDocument,
    ...
    "query fetchCurrentRide($id: uuid!) {\n  ride_details_by_pk(id: $id) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n  }\n}": typeof types.FetchCurrentRideDocument,
...
const documents: Documents = {
    ...
    "query fetchActiveRide($userId: uuid!) {\n  ride_details(\n    where: {user_id: {_eq: $userId}, end_time: {_is_null: true}, ride_steps: {steps: {_in: [\"RIDE_STARTED\", \"RIDE_PAUSED\", \"RIDE_RESUMED\"]}}, _not: {ride_steps: {steps: {_eq: \"RIDE_ENDED\"}}}}\n    order_by: {created_at: desc}\n    limit: 1\n  ) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n    scooter {\n      id\n      registration_number\n      status\n      device_name\n      imei\n    }\n    hubByStartHubId {\n      id\n      name\n      latitude\n      longitude\n    }\n  }\n}": types.FetchActiveRideDocument,
    "query fetchAllHubs {\n  hubs {\n    id\n    latitude\n    longitude\n    name\n    organization_id\n    created_at\n  }\n}": types.FetchAllHubsDocument,
    "query fetchCompletedRides($id: uuid = \"\") {\n  ride_details(\n    where: {ride_steps: {ride_detail: {ride_steps: {steps: {_eq: \"RIDE_ENDED\"}}}}, user_id: {_eq: $id}}\n  ) {\n    created_at\n    end_time\n    end_hub_id\n    id\n    scooter_id\n    start_hub_id\n    start_time\n    total_cost\n    ride_steps {\n      id\n      steps\n    }\n    hubByStartHubId {\n      latitude\n      longitude\n      name\n      id\n    }\n  }\n}": types.FetchCompletedRidesDocument,
    "query fetchCurrentRide($id: uuid!) {\n  ride_details_by_pk(id: $id) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n  }\n}": types.FetchCurrentRideDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query fetchActiveRide($userId: uuid!) {\n  ride_details(\n    where: {user_id: {_eq: $userId}, end_time: {_is_null: true}, ride_steps: {steps: {_in: [\"RIDE_STARTED\", \"RIDE_PAUSED\", \"RIDE_RESUMED\"]}}, _not: {ride_steps: {steps: {_eq: \"RIDE_ENDED\"}}}}\n    order_by: {created_at: desc}\n    limit: 1\n  ) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n    scooter {\n      id\n      registration_number\n      status\n      device_name\n      imei\n    }\n    hubByStartHubId {\n      id\n      name\n      latitude\n      longitude\n    }\n  }\n}"): (typeof documents)["query fetchActiveRide($userId: uuid!) {\n  ride_details(\n    where: {user_id: {_eq: $userId}, end_time: {_is_null: true}, ride_steps: {steps: {_in: [\"RIDE_STARTED\", \"RIDE_PAUSED\", \"RIDE_RESUMED\"]}}, _not: {ride_steps: {steps: {_eq: \"RIDE_ENDED\"}}}}\n    order_by: {created_at: desc}\n    limit: 1\n  ) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n    scooter {\n      id\n      registration_number\n      status\n      device_name\n      imei\n    }\n    hubByStartHubId {\n      id\n      name\n      latitude\n      longitude\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query fetchCurrentRide($id: uuid!) {\n  ride_details_by_pk(id: $id) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n  }\n}"): (typeof documents)["query fetchCurrentRide($id: uuid!) {\n  ride_details_by_pk(id: $id) {\n    id\n    start_time\n    created_at\n    user_id\n    scooter_id\n    start_hub_id\n    total_cost\n    ride_steps {\n      id\n      steps\n      created_at\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
