...
export type InputVariant = 'default' | 'dropdown' | 'phone' | 'currency';
...
/**
 * Base Input component with multiple variants: default, dropdown, phone, and currency
 */
      ...
      return (
        <View style={styles.phonePrefixContainer}>
          <Text
            style={[
              styles.prefixText,
              {color: colors.highlight, fontSize: typography.skP1.fontSize},
            ]}>
            {countryCode}
          </Text>
          <View
